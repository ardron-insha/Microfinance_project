...
Proportion of women with an account who save for school fees:
```{r, echo=FALSE, message= FALSE}
womenteducation <- sum(womenonly$Borrowed.in.past.12.months..for.education.or.school.fees=="yes")/sum(womenonly$Has.an.account== 1)
```
Proportion of men with an account who save for school fees:

```{r, echo=FALSE, message= FALSE}
womeneducaition <- sum(menonly$Borrowed.in.past.12.months..for.education.or.school.fees=="yes")/sum(menonly$Has.an.account== 1)
```
