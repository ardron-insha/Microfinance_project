...
(*) It would be good to show this as a dataframe with columns for min, median, quartiles and max so that every row can be variable then these can be easily compared to the same values (in the same structure) from the lowest 40 and 20 percent below.
